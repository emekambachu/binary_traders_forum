                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    <li>
                        <a href="{{ route('user-dashboard') }}" class="iq-waves-effect">
                            <i class="las la-dashboard iq-arrow-left"></i><span>Dashboard</span></a>
                    </li>
                    <li>
                        <a href="{{ route('investment.index') }}" class="iq-waves-effect">
                            <i class="las la-money iq-arrow-left"></i><span>Your Investments</span></a>
                    </li>
                    <li>
                        <a href="{{ route('investment.create') }}" class="iq-waves-effect">
                            <i class="las la-money iq-arrow-left"></i><span>New Investments</span></a>
                    </li>
                    <li>
                        <a href="{{ url('user/account-settings') }}" class="iq-waves-effect">
                                    ...
                                    <div class="iq-card-body p-0 ">
                                        ...
                                        <a href="#" class="iq-sub-card" >
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="{{ asset('auth/images/user/01.jpg') }}" alt="">
                                                </div>
                                        ...
                                        <a href="#" class="iq-sub-card" >
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="{{ asset('auth/images/user/04.jpg') }}" alt="">
                                                </div>
                                                <div class="media-body ml-3">
...
{{--                                        </div>--}}
                                        ...
                                        <a href="#" class="iq-sub-card" >
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="{{ asset('auth/images/user/03.jpg') }}" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                ...
                <ul class="navbar-list">
                    <li class="line-height">
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                            <img src="/photos/{{!empty($user->image) ? $user->image : 'noimage.png'}}" class="img-fluid rounded mr-3" alt="user">
                            <div class="caption">
                                ...
                                <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="" class="iq-sub-card iq-bg-primary-hover">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body ml-3">
                                                <h6 class="mb-0 ">${{ $user->wallet->amount }}</h6>
                                                <p class="mb-0 font-size-12">Wallet Balance</p>
                                            </div>
                                        </div>
                                    </a>

                                    <a href="{{ url('user/account-settings') }}" class="iq-sub-card iq-bg-primary-hover">
                                        <div class="media align-items-center">
                                            <div class="rounded iq-card-icon iq-bg-primary">
                                    ...
                                    <div class="d-inline-block w-100 text-center p-3">
                                        <a class="bg-primary iq-sign-btn" href="{{ route('user-logout') }}" role="button">
