                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="price-table mrb-30 text-center">
                        <div class="table-header">
                            <h6 class="price"><span class="price-currency">$</span>{{ number_format($package->min) }} - ${{ number_format($package->max) }}</h6>
                            <h2 class="pricing-plan-name">{{ $package->name }}</h2>
                        </div>
                        <div class="table-content">
                            <ul class="list-items">
                                <li><i class="fa fa-check mrr-10 text-green"></i>{{ $package->referral_bonus }}% Referral Bonus</li>
                                <li><i class="fa fa-check mrr-10 text-green"></i>{{ $package->monthly_profit }}% Monthly Profit</li>
                                <li><i class="fa fa-check mrr-10 text-green"></i>{{ $package->days_turnover }} Days Turnover</li>
                                <li><i class="fa fa-check mrr-10 text-green"></i>{{ $package->expert_advice }}</li>
                                <li><i class="fa fa-check mrr-10 text-green"></i>{{ $package->deposit_bonus }}% Deposit Bonus</li>
                            </ul>
                        </div>
                        <div class="table-footer">
                            <a href="{{ route('register') }}" class="cs-btn-one btn-primary-color">Sign up</a>
                        </div>
                    </div>
                </div>
                @endforeach
